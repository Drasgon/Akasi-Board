...
<div class="registerMainContainer">
  <div class="mainHeadline">
	...
	';
            ...
            $registerContainer .= '
  <form class="registerPreForm" method="POST" action="?page=Register&action=presubmit">';
...
<form class="registerMain" method="POST" action="?page=Register&subRegister=registerForm&action=formsubmit">
  ...
  <fieldset class="registerFielset">
    ...
    <div class="Container_reg">';
                ...
                if (isset($register_dataArray) && ($register_dataArray['everythingEmpty'] == true || $register_dataArray['captchaEmpty'] == true || $register_dataArray['captchaError'] == true)) {
                    ...
                    $captchaMsg = (isset($register_dataArray) && ($register_dataArray['everythingEmpty'] == true || $register_dataArray['captchaEmpty'] == true)) ? 'Sie müssen die Sicherheitsabfrage ausfüllen!' : '';
                    $captchaMsg = (isset($register_dataArray) && ($register_dataArray['captchaError'] == true)) ? 'Die eingegebene Zeichenfolge war falsch.' : '';
      ...
      <div class="reg_containerInput formError">
        <input type="text" name="captcha_code" id="captcha_code" size="10" maxlength="6" class="registerInputField"  autocomplete="off"/>
		' . $captchaMsg . '
      </div>
      <div class="reg_containerInput_desc">
        Geben Sie den unten stehenden Code, ohne Leerzeichen ein. Groß-/ und Kleinschreibung müssen nicht beachtet werden.
      </div>
    </div>
    <div class="Container_reg">
      <div class="register_captcha">
        <img id="captcha" src="./system/security/securimage/securimage_show.php" alt="CAPTCHA Image" />
        <div>';
    ...
    <div class="Container_reg">
      <div class="register_captcha">
        ...
        <div>';
                ...
                echo $registerForm;
?>
	<a href="#" onclick="document.getElementById('captcha').src = './system/security/securimage/securimage_show.php?' + Math.random(); return false">Anderes Bild anzeigen</a>
<?php
                $registerForm_sec = '
        </div>
      </div>
  ...
  <div class="submitPreForm">
    ...
    <input type="reset" value="Zurücksetzen">
                ...
                echo $registerForm_sec;
                
            }
            if (isset($register_dataArray) && ($register_dataArray['registerSuccess'] == '1')) {
                require('./system/interface/successpage_threadcreate.php');
                throwSuccess_thread("Registrierung erfolgreich<br>Sie werden in Kürze eine Bestätigungs E-Mail erhalten, welcher weitere Instruktionen beigelegt sind.", "?page=Index");
            }
        }
    }
}
